  ...
  return (
    <div className="flex h-[calc(100vh-120px)] flex-col">
      ...
      <div className="flex flex-1 flex-col overflow-hidden rounded-xl border border-gray-100 bg-brand-card shadow-sm">
        {/* Mensagens */}
        <div ref={listaRef} className="min-h-0 flex-1 overflow-y-auto p-5">
        ...
        {/* Sugestões fixas — não encolhem nem somem com o scroll do chat */}
        <div className="flex shrink-0 flex-wrap gap-2 border-t border-gray-100 bg-brand-card px-5 py-3">
